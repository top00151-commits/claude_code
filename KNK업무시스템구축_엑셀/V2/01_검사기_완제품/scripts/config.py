...
# E.비고 (23)
C_NOTE=23
# F.부서담당자 (24~31) — v2026.04d 복원: "제외" 선택 또는 담당자 이름 입력
C_DEPT_START = 24
# G.매출·수금 (32~33) — v2026.04e 신규: 기술영업팀(안지연·이새롬) 입력
C_INVOICE_DATE = 32    # 세금계산서 발행일
C_PAYMENT_DATE = 33    # 입금일
MAX_COL = 33
...
# C. 부서 구성
# ═══════════════════════════════════════════════════════════════
DEPTS = ["설계팀","검사기팀","개발혁신팀","품질팀","제조기술1팀","구매팀","가공팀","베트남"]
...
# v2026.04d: 부서담당자 컬럼 — "제외" 드롭다운 + 이름 직접 입력 허용
for _i in range(len(["설계팀","검사기팀","개발혁신팀","품질팀","제조기술1팀","구매팀","가공팀","베트남"])):
