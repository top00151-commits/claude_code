...
# E.비고 (22)
C_NOTE=22
# F.부서담당자 (23~29) — v2026.04d 복원: "제외" 선택 또는 담당자 이름 입력
C_DEPT_START = 23
# G.매출·수금 (30~31) — v2026.04e 신규: 기술영업팀(안지연·이새롬) 입력
C_INVOICE_DATE = 30
C_PAYMENT_DATE = 31
MAX_COL = 31
...
# C. 부서 구성 (자동화 7개 부서)
# ═══════════════════════════════════════════════════════════════
DEPTS = ["설계팀","전장설계팀","소프트웨어팀","구매팀","가공팀","제조기술2팀","베트남"]
...
# v2026.04d: 부서담당자 컬럼 — "제외" 드롭다운 + 이름 직접 입력 허용 (자동화 7부서)
for _i in range(7):
...
R3_MAP_PROJ = {
    ...
    22:"memo",                                         # 비고
    # 23~29: 부서담당자 7개 — "제외" 또는 이름 (sel_input)
    23:"sel_input", 24:"sel_input", 25:"sel_input", 26:"sel_input",
    27:"sel_input", 28:"sel_input", 29:"sel_input",
    # 30~31: 매출·수금
    30:"po_input",   # 계산서 발행일
    31:"po_input",   # 입금일
}
R4_MAP_PROJ = {
    ...
    27:"dept", 28:"dept", 29:"dept",
    # 30~31: 매출·수금 (payment)
    30:"payment", 31:"payment",
}
