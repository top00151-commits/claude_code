@echo off
REM ============================================================
REM   LAST UPDATE: 2026-05-05 v5H129 자재 등록 사진/도면 첨부 + 자동 압축
REM   (전체 변경 이력은 ../CHANGELOG.md 참조)
REM   업데이트 규칙: 01 세션이 코드 수정 시 본 라인 한 줄 요약만 갱신
REM ============================================================
chcp 65001 > nul
title KNK HAIST WORKS - HAIST Innovation [v5H129]
