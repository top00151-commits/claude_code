...
async def sales_orders_page(req: Request, biz: str = "", due_date: str = "", cal_ym: str = ""):
    ...
    # v5H167: 한국 + 베트남 공휴일 + 대체공휴일 (2026~2027)
    # 대체공휴일 규정: 설/추석/어린이날(토·일·공휴일 겹침) + 3·1·광복·개천·한글·부처님·성탄(일요일 겹침)
    HOLIDAYS_KR = {
        # ── 2026 ──
        "2026-01-01": "신정",
        "2026-02-16": "설날 연휴", "2026-02-17": "설날", "2026-02-18": "설날 연휴",
        "2026-03-01": "삼일절", "2026-03-02": "대체공휴일(삼일절)",  # 3/1 일요일
        "2026-05-05": "어린이날",
        "2026-05-24": "부처님오신날", "2026-05-25": "대체공휴일(부처님오신날)",  # 5/24 일요일
        "2026-06-06": "현충일",
        "2026-08-15": "광복절", "2026-08-17": "대체공휴일(광복절)",  # 8/15 토 → 월요일 대체
        "2026-09-24": "추석 연휴", "2026-09-25": "추석", "2026-09-26": "추석 연휴",
        "2026-09-28": "대체공휴일(추석)",  # 9/26 토요일
        "2026-10-03": "개천절",  # 토요일 — 대체 없음 (개천절은 일요일만 대체)
        "2026-10-09": "한글날",
        "2026-12-25": "성탄절",
        # ── 2027 ──
        "2027-01-01": "신정",
        "2027-02-05": "설날 연휴", "2027-02-06": "설날", "2027-02-07": "설날 연휴",
        "2027-02-08": "대체공휴일(설날)",  # 2/7 일요일
        "2027-03-01": "삼일절",
        "2027-05-05": "어린이날",
        "2027-05-13": "부처님오신날",
        "2027-06-06": "현충일",  # 일요일 — 현충일은 대체 대상 아님
        "2027-08-15": "광복절", "2027-08-16": "대체공휴일(광복절)",  # 8/15 일요일
        "2027-09-13": "추석 연휴", "2027-09-14": "추석", "2027-09-15": "추석 연휴",
        "2027-10-03": "개천절", "2027-10-04": "대체공휴일(개천절)",  # 10/3 일요일
        "2027-10-09": "한글날", "2027-10-11": "대체공휴일(한글날)",  # 10/9 토요일 → 월
        "2027-12-25": "성탄절",
    }
    HOLIDAYS_VN = {
        # ── 2026 ── (베트남은 휴일이 주말 겹치면 다음 평일 nghỉ bù)
        "2026-01-01": "Tết Dương lịch",
        "2026-02-16": "Tết Nguyên Đán", "2026-02-17": "Tết", "2026-02-18": "Tết",
        "2026-02-19": "Tết", "2026-02-20": "Tết",
        "2026-04-26": "Giỗ Tổ Hùng Vương",  # 음력 3/10
        "2026-04-27": "Nghỉ bù (Hùng Vương)",  # 4/26 일요일
        "2026-04-30": "Thống Nhất", "2026-05-01": "Quốc tế Lao động",
        "2026-09-02": "Quốc Khánh", "2026-09-03": "Quốc Khánh",
        # ── 2027 ──
        "2027-01-01": "Tết Dương lịch",
        "2027-02-05": "Tết Nguyên Đán", "2027-02-06": "Tết", "2027-02-07": "Tết",
        "2027-02-08": "Tết", "2027-02-09": "Tết",
        "2027-04-15": "Giỗ Tổ Hùng Vương",
        "2027-04-30": "Thống Nhất", "2027-05-01": "Quốc tế Lao động",
        "2027-05-03": "Nghỉ bù (Lao động)",  # 5/1 토요일
