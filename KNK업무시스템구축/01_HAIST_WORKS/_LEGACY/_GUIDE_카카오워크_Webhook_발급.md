...
> 카카오워크는 2026-04-22 대표 결재(D01-06 안A)로 완전 폐기됨.
> 알림 채널은 하이웍스 메신저로 단일화. 이 파일은 이력 보존 목적으로만 유지.
...
**문서 위치**: `KNK업무시스템구축/01_HAIST_WORKS/_LEGACY/_GUIDE_카카오워크_Webhook_발급.md`
**원본 작성**: 빅터 (2026-04-20)
**폐기 처리**: 2026-04-22 대표 결재(D01-06 안A) — 카카오워크 완전 폐기
