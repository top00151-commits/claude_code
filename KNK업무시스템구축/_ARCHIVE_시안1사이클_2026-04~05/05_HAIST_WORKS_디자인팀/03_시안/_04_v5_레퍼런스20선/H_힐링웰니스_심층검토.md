...
3. **B2B에도 따뜻함 진입** — Ember(헬스케어 SaaS, 앰버톤 50+ 페이지), 외부 메신저 유머 알림, Asana 유니콘 = "B2B는 무조건 차가워야" 가 깨짐
...
| **H8** | **차분한 자연풍경 (명상앱 Nature Scape)** | 그라데이션 하늘 + 산 실루엣 + 세리프 | #E8D5C0→#A8B5C0·serif | ★★★☆☆ | 명상앱 앱 톤, 감성 강함 |
...
- **데이터 시각화만 따뜻한 오렌지/레드 스케일** — 결제 대시보드·개발자 도구 의 차가움을 깨뜨리는 2026 신 패턴
...
## H8. 차분한 자연풍경 (명상앱 Nature Scape) ★★★☆☆

### 핵심
- 명상앱 앱 톤 — 그라데이션 하늘 + 산 실루엣 + 세리프 헤드라인
- 감성 ★★★★★ / 업무 효율 ★★☆☆☆
