...
title KNK HAIST WORKS - HAIST Innovation [v5H175]

echo.
echo ============================================================
echo    HAIST WORKS  ^|  KNK Integrated Work Platform
echo    Human ^& AI create the Best
echo    [v5H175  2026-05-06]
echo ============================================================
echo.
