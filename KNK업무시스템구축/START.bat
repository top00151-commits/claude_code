@echo off
REM ============================================================
REM   LAST UPDATE: 2026-05-11 v5H226z75 (Synology NAS Docker 배포 패키지 + 보안 .gitignore — Ubuntu 20.04)
...
set PYTHONUTF8=1
title KNK HAIST WORKS - HAIST Innovation [v5H226z75]

echo.
echo ============================================================
echo    HAIST WORKS  ^|  KNK Integrated Work Platform
echo    Human ^& AI create the Best
echo    [v5H226z75  2026-05-11]
echo ============================================================
echo.
