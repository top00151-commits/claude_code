...
title KNK HAIST WORKS - HAIST Innovation [v5H170]

echo.
echo ============================================================
echo    HAIST WORKS  ^|  KNK Integrated Work Platform
echo    Human ^& AI create the Best
echo    [v5H170  2026-05-06]
echo ============================================================
echo.
