@echo off
REM ============================================================
REM   LAST UPDATE: 2026-05-02 v5H6 자율 점검 10항 — po_receive 빠른입력+진행률, stock_movements 기간프리셋+CSV+합계, progress_dashboard KPI4, base*.html → _legacy_base 이관, menu_catalog 60→85 (Phase2 25건), t() Jinja 전역, dock JS API 스키마 정합, print CSS var() → 하드코드, 모바일(1023px) 사이드바 toggle + 햄버거 / Jinja2 153/153 PASS
