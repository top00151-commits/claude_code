#!/bin/bash
# z1126 회귀 묶음 — 고친 사본(z1126/app_new · 취소 알림 글 새 규칙)으로 기존 시험 전부
...
W="$B/2026-09-26_2305_취소알림문구_새규칙맞춤_WORKS준비물"; W25="$B/2026-09-26_2121_회의록지울때_녹음파일도함께_WORKS준비물"; W23="$B/2026-09-22_0022_이음회의삭제도_회의록함께_WORKS준비물"; W24="$B/2026-09-22_0815_모아보기_회의록열기_이름맞춤_WORKS준비물"
R="$SP/z1126/reg"; APPW="C:/Users/top00/AppData/Local/Temp/claude/C--Users-top00-JR-Claude---/31b97fce-95eb-4c01-8a66-eddd91b2bd12/scratchpad/z1126/app_new"
APPU="$SP/z1126/app_new"
...
"$W/restart26.sh" app_new 8942 >> "$OUT" 2>&1 && { timeout 900 "$P312" "$W24/ui_del_z1124.py" "$W/seed_app_new" > "$R/ui_del.log" 2>&1; res ui_del_z1124 "$R/ui_del.log"; }
"$W/restart26.sh" app_new 8942 >> "$OUT" 2>&1 && { timeout 900 "$P312" "$W/ui_z1126.py" "$W/seed_app_new" > "$R/ui_z1123.log" 2>&1; res ui_z1126 "$R/ui_z1123.log"; }
kill_port 8942
# 8) 서버 시험(TestClient)
for t in "2026-09-18_1016_회의록_녹음서버저장_창닫혀도끝내기_WORKS준비물/verify_rec.py" "2026-09-20_2240_회의록_녹음기공유로자동정리_WORKS준비물/verify_share.py" "2026-09-18_2249_회의록_녹음중뒤로가기_다른앱경고_WORKS준비물/verify_msg_rec.py" "2026-09-21_1830_회의카드모아보기_끝났는데회의중_WORKS준비물/verify_cards_rec.py" "2026-09-21_2200_이음카드_이어서녹음_rec_mine_WORKS준비물/verify_msg_mine.py" "2026-09-17_0845_회의카드모아보기_WORKS준비물/verify_cards.py" "2026-09-21_2313_회의록삭제_두번확인_이음회의연동_WORKS준비물/verify_del.py" "2026-09-22_0022_이음회의삭제도_회의록함께_WORKS준비물/verify_z1123.py" "2026-09-26_2305_취소알림문구_새규칙맞춤_WORKS준비물/verify_z1126.py"; do
