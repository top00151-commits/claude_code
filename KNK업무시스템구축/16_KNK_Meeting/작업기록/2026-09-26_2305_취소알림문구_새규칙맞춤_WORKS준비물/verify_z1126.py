# -*- coding: utf-8 -*-
"""z1125+z1126 서버 시험 — 회의록을 지우면 그 회의의 녹음 파일도 함께 (대표 결정 2026-09-26 「지울때 함께 지워」)
...
chk("(나 말고 참석자가 있으면 「회의가 취소되었습니다」 알림이 갑니다)" in h, "z1126: 첫 확인 창에 취소 알림 줄")
chk("시작 전 회의라" not in h, "z1126: 옛 글 「시작 전 회의라」 없음")
